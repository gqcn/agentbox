...
// UsersDao is the data access object for the table john_ai_agentbox_users.
...
// UsersColumns defines and stores column names for the table john_ai_agentbox_users.
type UsersColumns struct {
	Id           string // User ID
	Username     string // Login username
	PasswordHash string // BCrypt password hash
	Role         string // AgentBox role
	Status       string // User status
	LastLoginAt  string // Last successful login time
	DeletedAt    string // Soft deletion time
	CreatedAt    string // Creation time
	UpdatedAt    string // Update time
}

// usersColumns holds the columns for the table john_ai_agentbox_users.
