...
// UserSettingsDao is the data access object for the table john_ai_agentbox_user_settings.
...
// UserSettingsColumns defines and stores column names for the table john_ai_agentbox_user_settings.
...
// userSettingsColumns holds the columns for the table john_ai_agentbox_user_settings.
...
func NewUserSettingsDao(handlers ...gdb.ModelHandler) *UserSettingsDao {
	return &UserSettingsDao{
		group:    "default",
		table:    "john_ai_agentbox_user_settings",
